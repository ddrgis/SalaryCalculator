...
* Доменная модель
* Каркас архитектуры
* Функционал расчета зарплат
* Написаны основные тесты для доменной модели
### Осталось сделать:
* Возможность просматривать подчиненных
* Возможность добавления/удаления/редактирования подчиненных
* Доделать пользовательский интерфейс
...
* Добавить возможность расчета суммарной зарплаты для изолированных деревьев (когда нет одного общего босса)
* Перезагрузить методы Equals и GetHashCode для Person
* Добавить валидацию форм
* Добавить Parameter Object для избавления от большого числа параметров в конструкторах, фабрике и для удобного маппинга из ViewModel
